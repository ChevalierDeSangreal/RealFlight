...
echo "======================================"
echo "Starting Hover Test System (50Hz)"
echo "Drone ID: $DRONE_ID | Mode: $MODE"
echo "======================================"

# 1. Create Session and start Hover Test (Left Pane - Pane 0)
echo "Launching Hover Test Node (50Hz)..."
tmux new-session -d -s "$SESSION_NAME" -n "mission" \
    "$ROS2_SETUP && ros2 launch hover_test tflite_neural_control_50hz.launch.py \
...
echo "Pane 0 (Left): Hover Test Node (50Hz)"
