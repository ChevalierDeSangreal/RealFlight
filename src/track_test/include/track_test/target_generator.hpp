 ...
 * 2. 话题模式 (use_target_topic=true): 订阅ROS2话题获取实时目标位置
 */
...
public:
  /**
   * @brief 构造函数
   * @param node ROS2节点指针(用于创建订阅者)
   * @param use_target_topic 是否使用ROS2话题订阅目标
...
private:
  ...
  // ROS2 subscribers (only used in topic mode)
